...
public class Student
{
	...
	/**
	 * Creates a new student given a first and last name. An id number is
	...
	/**
	 * Sets the student's current earned credits. (This should really be done by
	 * looking at a list of completed courses, not by setting it directly.)
	 * 
	 * @param currentEarnedCr
	 *          the number of current earned credits
	 */
	...
	/**
	 * Sets the student's anticipated additional credits (the courses they are
	 * currently taking). (This should really be done by looking at a list of
	 * registered courses, not by setting it directly.)
	 * 
	 * @param anticipatedAdditionalCr
	 *          the number of anticipated additional credits
	 */
	...
	/**
	 * Sets whether the student has completed the LASC requirements. (This
	 * should really be done by looking at a list of completed courses, not by
	 * setting it directly.)
	 * 
	 * @param lascComplete
	...
	/**
	 * Sets whether the student has completed the major requirements. (This
	 * should really be done by looking at a list of completed courses, not by
	 * setting it directly.)
	 * 
	 * @param majorComplete
	...
	{
		return getCurrentRemainingCr() == 0 && gpa >= 2.0 && gpa <= 6.0 && lascComplete && majorComplete;
	}
}